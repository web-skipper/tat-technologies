<?php /*Template Name: Investers News Page */
get_header();
$pid = $post->ID; ?>
...
<div class="inner_main invetnews_main" id="skypcon">
    ...
    <?php $investor_news = get_field('investor_news', $pid); ?>
    <?php
    ...
    $args = array(
        ...
        'tax_query' => array(
            ...
            array(
                ...
                'field' => 'term_id',
                'terms' => $investor_news['post_type_category'],
            ),
            array(
                'taxonomy' => 'category',
                'field' => 'term_id',
                'terms' => $investor_news['post_category'],
            ),
        ),
    );
                ...
                <ul>
                    <?php if ($query->have_posts()): ?>
                        ...
                        while ($query->have_posts()):
                            ...
                            ?>
                            <li>
                                <?php get_template_part('template-parts/content', 'newsroom', $args); ?>
                            </li>
                            <?php $postloopindex++;
                        endwhile;
                        wp_reset_postdata();
