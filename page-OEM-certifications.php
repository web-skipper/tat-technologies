<?php /*Template Name: OEM - Certifications Page */
get_header();
$pid = $post->ID; ?>
...
<div class="inner_main mro_main_certification" id="skypcon">
    ...
    <div class="mroban">
        <div class="breadcrumbs"><a href="<?php bloginfo('url'); ?>">Home</a><span class="breadarow"></span><a
                href="#">Commercial</a><?php if (function_exists('bcn_display')) {
                    bcn_display();
                } ?></div>
