...
<body <?php body_class(); ?>>
    ...
    <div class="main_container" id="wrapper">
        <div class="header">
            ...
            <div class="hright">
                <div class="hrightin">
                	<div class="menutoggle"><a href="Javascript:void(0);"><img alt="layer" src="<?php bloginfo('template_directory'); ?>/images/menuvector.svg" /></a></div>
                    <div class="hmenu">
                    	<div class="menutoglclose"><a href="Javascript:void(0);"><img alt="layer" src="<?php bloginfo('template_directory'); ?>/images/menutoglclose.svg" /></a></div>
                        <div class="hmenuone">
                    ...
                    <div class="hsearch">
                        <a href="Javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
