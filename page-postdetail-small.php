...
<div class="inner_main newspostsma_main" id="skypcon">
    <div class="newspostsban">
        <div class="newspostbatxt">
            <h1>TAT to Participate at The Benchmark Company’s Discovery Investor Conference on Dec. 11</h1>
            <div class="nabandate">December 28, 2024</div>
        </div>
    </div>
    <div class="newspostmid">
        <div class="newspostmleft">
            <div class="newspostsmimg"><img alt="layer"
                    src="<?php bloginfo('template_directory'); ?>/images/newpsmimg.png" /></div>
            ...
            <div class="newsposttopic">
                ...
                <div class="newspostag">
                    <div class="tagin">NextGen Systems</div>
                    <div class="tagin">Thermal Products</div>
                </div>
            </div>
        </div>
        <div class="newspostmright">
            <p>TAT is a trusted partner, proactively solving complex aerospace challenges to enable our partners to
                operate with confidence and achieve operational success across their thermal, APU and landing gear
                systems.</p>
            ...
            <p>TAT is a trusted partner, <a href="#">Link in the text</a> complex aerospace challenges to enable our
                partners to operate List:
                TAT is a trusted partner</p>
            <ul>
                <li>TAT is a trusted partner</li>
                <li>proactively solving</li>
                <li>omplex aerospace</li>
            </ul>
            <p>List Numbers:</p>
            <ol start="1">
                <li>TAT is a trusted partner</li>
        ...
        <div class="newpmoright">
            <ul>
                <li>
                    <a href="#">
                        <div class="newspmordet">
                            <h4>Company’s Discovery</h4>
                            <div class="newspmodate">Blog <span></span> Nextgen Systems <span></span> December 28, 2024
                            </div>
                        </div>
                        <div class="newspmorimg">
                            <img alt="layer" src="<?php bloginfo('template_directory'); ?>/images/nmoreimg1.png" />
                        </div>
                        <div class="clr"></div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="newspmordet">
                            <h4>Benchmark Company’s Discovery Investor Conference on</h4>
                            <div class="newspmodate">Blog <span></span> Nextgen Systems <span></span> December 28, 2024
                            </div>
                        </div>
                        <div class="newspmorimg">
                            <img alt="layer" src="<?php bloginfo('template_directory'); ?>/images/nmoreimg2.png" />
                        </div>
                        <div class="clr"></div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="newspmordet">
                            <h4>Participate at The Benchmark Company’s Discovery Investor Conference on Dec. 11</h4>
                            <div class="newspmodate">Blog <span></span> Nextgen Systems <span></span> December 28, 2024
                            </div>
                        </div>
                        <div class="newspmorimg">
                            <img alt="layer" src="<?php bloginfo('template_directory'); ?>/images/nmoreimg3.png" />
                        </div>
                        <div class="clr"></div>
                    </a>
                </li>
            </ul>
            <div class="npmrbut"><a href="#">All News <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
